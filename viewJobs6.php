...
<?php include 'includes/navbar.php';?>
 <?php include 'includes/subMenuSC.php'; ?> 
    <div class="container mt-6">
        ...
        /* echo  $total_pages; */
        $pagLink = "<div class='pt-3'><ul class='justify-content-end pagination '>
                            ...
                            <div class="fr-right-detail-content">
                                ...
                                ?>
                                    ...
                                    <div class="fr-jobs-price">
                                        <div class="style-hd">
                                            Rs 100-500<small class="protip" data-pt-position="top"
                                ...
                                <div class="fr-right-list">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <span>
                                               <?php echo   $job_data->address.', '.$job_data->city; ?> </span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="fr-right-bid">
                                    <ul>
                                        <li> <a href="javascript:void(0);" class="mark_fav protip" data-post-id="2669"
                                                ...
                                                data-pt-title="Save project"><i class="fa fa-heart active"
                                                    aria-hidden="true"></i></a> </li>
                                                    <form action="openBid.php" method="post">
                                        <input type="hidden" name="jobId" value="<?php echo $job_data->jobId; ?>" >
                                        <input type="hidden" name="custid" value="<?php echo $job_data->custid; ?>" >
                                        <button type="submit" name="submitbtn" class="btn btn-theme btn-bid-now">Bid Now</button>
                                        </form>            
                                    </ul>
                                </div>
                            </div>
